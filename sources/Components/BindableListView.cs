    ...
    public class BindableListView : ListView
    {
            ...
            if (BindingContext != null)
            {
                ...
                if (currencyManager != _currencyManager)
                {
                    ...
                    if (_currencyManager != null)
                    {
                        ...
                        currencyManager.ItemChanged -= new ItemChangedEventHandler(ItemChanged);
                    }
        ...
        private void LoadItemsFromSource()
        {
            ...
            try
            {
                ...
                int index = _currencyManager.Position;
                if (index != -1)
        ...
        private void ListChanged(object sender, ListChangedEventArgs e)
        {
            switch (e.ListChangedType)
            {
                ...
                case ListChangedType.ItemChanged:
                    object changedRow = _currencyManager.List[e.NewIndex];
                    BeginUpdate();
                ...
                case ListChangedType.ItemAdded:
                    object newRow = _currencyManager.List[e.NewIndex];
        ...
        private void ItemChanged(object sender, ItemChangedEventArgs e)
        {
            ...
            if (e.Index == -1)
            {
                ...
                if (!object.ReferenceEquals(_bindingList, _currencyManager.List))
                {
